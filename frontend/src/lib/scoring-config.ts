...
export const SCORING_MAP: Record<string, Record<string, number>> = {
  q1: { "Sole Trader": 3, "Company": 2, "Partnership": 1, "Trust": 0 },
  q2: { "Under $10k": 5, "$10k-$50k": 2, "$50k-$200k": -2, "Over $200k": -4 },
  q3: { "Under 6 months": 4, "6-12 months": 1, "1-2 years": -2, "Over 2 years": -4 },
  q4: { "None": 5, "Overdue notice": 2, "Garnishee notice": -2, "Statutory demand": -4, "Wind-up notice": -5, "Bankruptcy notice": -6 },
  q5: { "Yes - all current": 6, "Mostly current": 2, "Partially lodged": -2, "Not current": -5 },
  q6: { "All lodged": 4, "Minor arrears": 1, "Significant arrears": -2, "Never lodged": -4 },
  ...
  q10: { "No": 3, "Minor": 1, "Significant": -2, "Overwhelming": -4 },
  q11: { "Under $500": -4, "$500-$1,500": 0, "$1,500-$3,000": 3, "Over $3,000": 5 },
  q12: { "Under 12 months": 2, "12-24 months": 1, "24-36 months": 0, "Over 36 months": -1 },
  ...
  q15: { "Planning ahead": 4, "Moderate urgency": 1, "High urgency": -2, "Critical - ATO threatening action": -4 },
};

export const STRENGTH_MAP: Record<string, { answers: string[]; message: string }> = {
  q1: { answers: ["Sole Trader"], message: "Simpler structure reduces compliance complexity" },
...
export const ACTION_MAP: Record<string, { question: string; answers: string[]; message: string }> = {
  q4_garnishee: { question: "q4", answers: ["Garnishee notice"], message: "Seek immediate legal advice — garnishee notice requires urgent response" },
  ...
  q15_critical: { question: "q15", answers: ["Critical - ATO threatening action"], message: "ATO enforcement imminent — seek professional representation before responding" },
  q15_high: { question: "q15", answers: ["High urgency"], message: "Engage professional support promptly to preserve negotiation options" },
};

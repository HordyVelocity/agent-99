...
export const SCORING_MAP: Record<string, Record<string, number>> = {
  ...
  q7: { "No": 1, "Successful": 3, "Defaulted": -3, "Attempted - rejected": -2 },
  q8: { "Yes": 1, "No": 0, "Recently resigned": -2 },
  q9: { "No": 5, "Non-lockdown DPN": -3, "Lockdown DPN": -6, "Unsure": -1 },
  q10: { "No": 3, "Small amount": 1, "Significant": -2, "Major liabilities": -4 },
